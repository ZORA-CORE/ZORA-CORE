...
class ZoraRepoMonitor:
    ...
    def __init__(self):
        ...
        print(f"🔍 ZORA Repository Monitor initialized - ID: {self.monitor_id}")
    ...
    def start_monitoring(self):
        ...
        print("🔍 ZORA Repository Monitor activated")
        print(f"📊 Monitoring {len(self.zora_repos['github'])} GitHub repos")
        print(f"🔧 Monitoring {len(self.zora_repos['replit'])} Replit repos")
        print("🚨 Auto-fix enabled for critical issues")
    ...
    async def run_monitoring_loop(self):
        ...
        print("🔍 Repository monitoring loop initiated")
    ...
    def shutdown(self):
        ...
        print("🔍 ZORA Repository Monitor shutting down...")
...
if __name__ == "__main__":
    print("🔍 Starting ZORA Repository Monitor in standalone mode...")
    repo_monitor.start_monitoring()
    
    try:
        asyncio.run(repo_monitor.run_monitoring_loop())
    except KeyboardInterrupt:
        print("🛑 Repository monitoring interrupted")
