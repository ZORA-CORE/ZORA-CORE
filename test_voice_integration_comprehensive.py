...
try:
    ...
    print(f"⚠️ Voice systems not available: {e}")
...
class TestZoraVoiceIntegration:
    ...
    def test_voice_manager_initialization(self):
        ...
        assert status["system_name"] == "ZORA Agent Voice Manager™"
    ...
    def test_voice_integration_system_initialization(self):
        ...
        assert status["system_name"] == "ZORA Agent Voice Integration™"
        assert status["version"] == "1.0.0"
        ...
        if hasattr(zora_voice_generator, 'synthesize_voice') and zora_voice_generator.voice_personalities:
            try:
                ...
                if audio_data is not None:
                    ...
                    print("✅ Voice synthesis test successful for CONNOR")
                else:
                    print("⚠️ Voice synthesis returned None - may need GPU/dependencies")
                    
            except Exception as e:
                print(f"⚠️ Voice synthesis test failed (expected without GPU): {e}")
        ...
        if hasattr(zora_voice_generator, 'generate_personality_vector') and zora_voice_generator.voice_personalities:
            ...
            if connor_personality:
                try:
                    ...
                    print("✅ Voice personality vector generation successful")
                    
                except ImportError:
                    print("⚠️ PyTorch not available for vector generation test")
                except Exception as e:
                    print(f"⚠️ Vector generation test failed: {e}")
    ...
    def test_text_tokenization(self):
        ...
        if hasattr(zora_voice_generator, 'text_to_tokens'):
            try:
                ...
                print("⚠️ PyTorch not available for tokenization test")
            except Exception as e:
    ...
    async def test_batch_agent_integration(self):
        ...
        if zora_agent_voice_integration.voice_enabled:
            ...
            for agent_name, result in results.items():
                ...
                print(f"Agent {agent_name} integration: {'✅ Success' if result else '❌ Failed'}")
    ...
    def test_voice_queue_functionality(self):
        ...
        if hasattr(zora_agent_voice_integration, 'queue_voice_synthesis'):
            ...
            if zora_agent_voice_integration.voice_enabled:
                assert isinstance(result, bool)
                print(f"Voice queue test: {'✅ Success' if result else '❌ Failed'}")
        ...
        if manager_available and integration_available:
            ...
            if result:
                ...
                if hasattr(test_agent, 'get_voice_status'):
                    ...
                    print("✅ End-to-end voice workflow successful")
                else:
                    print("⚠️ Voice status method not properly integrated")
            else:
                print("⚠️ Voice integration failed in end-to-end test")
        else:
            print("⚠️ Voice systems not fully available for end-to-end test")
...
if __name__ == "__main__":
    print("🎤 Testing ZORA Voice Integration Systems™...")
