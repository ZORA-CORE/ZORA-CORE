...
def run_brand_mashup_tests():
    ...
    print("🧪 Running ZORA Brand Mashup Engine™ tests...")
    ...
    try:
        ...
        if exit_code == 0:
            print("✅ All Brand Mashup Engine tests passed!")
            return True
        else:
            print("❌ Some Brand Mashup Engine tests failed")
            return False
            
    except Exception as e:
        print(f"❌ Error running Brand Mashup Engine tests: {e}")
        return False
