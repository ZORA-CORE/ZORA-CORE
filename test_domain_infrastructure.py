...
try:
    ...
    print(f"⚠️ Domain Infrastructure not available for testing: {e}")
...
def run_domain_infrastructure_tests():
    ...
    if not DOMAIN_INFRASTRUCTURE_AVAILABLE:
        print("❌ Domain Infrastructure not available - skipping tests")
        return False
    
    print("🧪 Running ZORA Global Domain Infrastructure™ tests...")
    ...
    try:
        ...
        if exit_code == 0:
            print("✅ All Domain Infrastructure tests passed!")
            return True
        else:
            print("❌ Some Domain Infrastructure tests failed")
            return False
            
    except Exception as e:
        print(f"❌ Error running Domain Infrastructure tests: {e}")
        return False
